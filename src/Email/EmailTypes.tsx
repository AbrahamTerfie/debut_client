...
export const EmailHeaders = (
    ...
    if (emailType === EmailTypes.peopleIntroduction) {
        console.log("peopleIntroduction", emailType, EmailTypes.peopleIntroduction)
    ...
    if (emailType === EmailTypes.companyIntroduction) {
        console.log("companyIntroduction", emailType, EmailTypes.companyIntroduction)
    ...
    if (emailType === EmailTypes.helpWithGoal) {
        console.log("helpWithGoal", emailType, EmailTypes.helpWithGoal)
    ...
    if (emailType === EmailTypes.helpWiithItem) {
        console.log("helpWiithItem", emailType, EmailTypes.helpWiithItem)
        return `<h5> Hi there,</h5></br>
