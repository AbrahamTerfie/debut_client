...
mutation updateCompanyGoal($updateCompanyGoalId: ID!, $companyGoalInput: CompanyGoalInput) {
  updateCompanyGoal(id: $updateCompanyGoalId ,companyGoalInput: $companyGoalInput) {
    _id
    goalTitle
    goalDescription
    goalStatus
